...
#[cxx_qt::bridge(cxx_file_stem = "rust_cxx_qt_bevy_app")]
pub mod qobject {
    ...
    unsafe extern "RustQt" {
        ...
        // We tell CXX-Qt that we want a QObject class with the name MyBevyApp
        // based on the Rust struct MyBevyAppRust.
        #[qobject]
        #[qml_element]
        #[qproperty(i32, number)]
        #[qproperty(QString, string)]
        type MyBevyApp = super::MyBevyAppRust;
    }
    ...
    unsafe extern "RustQt" {
        ...
        #[qinvokable]
        fn increment_number(self: Pin<&mut MyBevyApp>);

        #[qinvokable]
        fn say_hi(self: &MyBevyApp, string: &QString, number: i32);
    }
